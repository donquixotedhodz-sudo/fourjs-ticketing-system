                            ...
                            <?php foreach ($cleaningServices as $service): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editModal_<?= $service['id'] ?>" title="Edit" style="padding: 0.2rem 0.4rem; font-size: 0.75rem;">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <!-- Delete Button (icon only) -->
                                        <button type="button" class="btn btn-sm btn-danger" title="Delete" onclick="confirmDelete(<?= $service['id'] ?>)" style="padding: 0.2rem 0.4rem; font-size: 0.75rem;">
